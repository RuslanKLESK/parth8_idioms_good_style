...
class Main
  ...
  def show_stations_list_on_route
    ...
    has_route?(number).length.zero? ? puts "Route not found." : route = has_route?(number).first
  ...
  def show_trains_on_station
    ...
    has_station?(name).length.zero? ? puts "Station not found." : station = has_station?(name).first
